            ...
            <Flex mb={['1em','4em']} direction={['column','row']}  >
                <Center ml='7em'>
                    <Box p='2em'>
                        ...
                        <Text fontSize='lg' >розробники ігор,які відповідають за проектування та розробку відеоігор для ПК,
                            консолей і мобільних додатків.<br/> Їхня робота полягає в тому, щоб закодувати базовий двигун на основі ідей команди дизайнерів.<br/>
