  ...
  return (
      <Layout home>
        <Head>
          ...
          <Box  bg='black'>
              <Text p={['1em','5em']} fontSize='xl' color='white'>Програміст – це дуже узагальнене поняття, яке в собі об’єднує кількадесят напрямів. Ваш вибір залежить від того, які саме продукти чи сервіси ви хочете створювати – займатись розробкою штучного інтелекту, створювати розумні пристрої, розробляти роботів, займатись захистом даних, чи вчитись систематизувати велетенську кількість даних та аналізувати їх.</Text>
          </Box>
          <Center mt='1em'>
                  <Heading size='2xl' p='1em'>Популярні професії</Heading>
          </Center>
        <SimpleGrid m={['1em','2em','5em']} columns={[1,2]} spacing={10}>
